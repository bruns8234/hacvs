...
function PictureManager() {
    ...
    /**********************************************/
    /** Private Eigenschaften von PictureManager **/
    /**********************************************/
    ...
    /*****************************************/
    /** Private Methoden von PictureManager **/
    /*****************************************/


    /**
    @description    Lädt ein durch Pfad und Dateiname spezifiziertes Imagefile und legt es in images ab.
    @param          {string}            basePath                        Pfad zum Speicherort der Soundfiles (Angabe inkl. abschließenden Backslash!)
    ...
    **/
    ...
    @param          {string}        name                Name des Imagefiles (ohne Extension!)
    @param          {function}      handleLoaded        Funktion die Aufgerufen werden soll wenn das Imagefile bereit ist.
    **/
    ...
    /**
    @description    Lädt alle Imagefiles, die in der übergebenen Liste aufgeführten sind, in den PictureManager.
    @param          {array[string]}     resources                       Liste aller Images, die geladen werden sollen (ohne Pfad, mit Ext.)
    @param          {function}          handleLoadDone                  Funktion die aufgerufen wird, wenn alle Images geladen wurden und der PictureManager
                                                                            "funktionsbereit" ist.
    **/
